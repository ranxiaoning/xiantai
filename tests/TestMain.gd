...
func _initialize() -> void:
	...
	_maybe_run("TestMenuScreens",      func(): return load("res://tests/suites/TestMenuScreens.gd").new())
	_maybe_run("TestSafeNodeUi",       func(): return load("res://tests/suites/TestSafeNodeUi.gd").new())
	...
	_maybe_run("TestStartNodeLogic",    func(): return load("res://tests/suites/TestStartNodeLogic.gd").new())
	_maybe_run("TestPlayerJourneyFlow", func(): return load("res://tests/suites/TestPlayerJourneyFlow.gd").new())
